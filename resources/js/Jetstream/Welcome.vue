    ...
    <div class="row justify-content-center my-5">
        <div class="col-md-12">
            <div class="card bg-light shadow">
                <div class="card-body border-bottom rounded-top bg-white px-5 py-3">
                    <div class="mx-3 my-3">
                        <div>
                            <jet-application-logo style="width: 317px" />
                        </div>

                        <h3 class="h3 my-4">Welcome to your Jetstream application!</h3>

                        <div class="text-muted">
                            Laravel Jetstream provides a beautiful, robust starting point for your next Laravel application. Laravel is designed to
                            help you build your application using a development environment that is simple, powerful, and enjoyable. We believe you
                            should love expressing your creativity through programming, so we have spent time carefully crafting the Laravel ecosystem
                ...
                <div class="row g-0">
                    <div class="col-md-6 pe-0">
                        <div class="card-body border-right border-bottom h-100 p-3">
                            <div class="d-flex bd-highlight mb-3 flex-row">
                                ...
                                <div class="ps-3">
                                    <div class="mb-2">
                                        <a href="https://laravel.com/docs" class="h5 font-weight-bolder text-decoration-none text-dark">
                                            Documentation
                                        </a>
                                    </div>
                                    <p class="text-muted">
                                    ...
                                    <a href="https://laravel.com/docs" class="text-decoration-none">
                                        <div class="d-flex align-content-center font-weight-bold text-primary mt-3">
                                            <div>Explore the documentation</div>

                                            <div class="text-primary ms-1">
                                                <svg viewBox="0 0 20 20" fill="currentColor" width="16" class="arrow-right h-4 w-4">
                                                    <path
                                                        fill-rule="evenodd"
                    ...
                    <div class="col-md-6 ps-0">
                        <div class="card-body border-bottom h-100 p-3">
                            <div class="d-flex bd-highlight mb-3 flex-row">
                                <div>
                                    <svg
                                        fill="none"
                    ...
                    <div class="col-md-6 pe-0">
                        <div class="card-body border-right h-100 p-3">
                            <div class="d-flex bd-highlight mb-3 flex-row">
                                <div>
                                    <svg
                                        fill="none"
