                                        ...
                                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg">
                                            <div class="dropdown-inner">
                                                <ul class="link-list-plain">
                                                    <li>
                                                        <Link href="/dashboard" class="dropdown-item d-flex align-items-center">
                                                            <em class="icon ni ni-dashboard me-2"></em>
                                                            <span>Dashboard</span>
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <Link :href="'/dashboard/subscription'" class="dropdown-item d-flex align-items-center">
                                                            <em class="icon ni ni-file-text me-2"></em>
                                                            <span>My Subscription</span>
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <Link href="/dashboard/subscription/payments" class="dropdown-item d-flex align-items-center">
                                                            <em class="icon ni ni-report-profit me-2"></em>
                                                            <span>Payment History</span>
                                                        </Link>
                                                    </li>
                                                    <li v-if="user.is_subscribed">
                                                        <a href="/dashboard/subscription/downloads" class="dropdown-item d-flex align-items-center">
                                                            <em class="icon ni ni-history me-2"></em>
                                                            <span>Downloads History</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <Link href="/dashboard/address-lists" class="dropdown-item d-flex align-items-center">
                                                            <em class="icon ni ni-download-cloud me-2"></em>
                                                            <span>Download Addresses</span>
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <Link href="/dashboard/maps" class="dropdown-item d-flex align-items-center">
                                                            <em class="icon ni ni-globe me-2"></em>
                                                            <span>Address Maps</span>
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <a href="/" class="dropdown-item d-flex align-items-center">
                                                            <em class="icon ni ni-dashlite me-2"></em>
                                ...
                                <div class="nk-sidebar-menu" data-simplebar>
                                    ...
                                    <ul class="nk-menu">
                                        ...
                                        <li class="nk-menu-item">
                                            <Link href="/dashboard" class="nk-menu-link">
                                                <span class="nk-menu-icon"><em class="icon ni ni-dashboard"></em></span>
                                                <span class="nk-menu-text">Dashboard</span>
                                            </Link>
                                        </li>
                                        <li class="nk-menu-item">
                                            <Link :href="'/dashboard/subscription'" class="nk-menu-link">
                                                <span class="nk-menu-icon"><em class="icon ni ni-file-text"></em></span>
                                                <span class="nk-menu-text">My Subscription</span>
                                            </Link>
                                        </li>
                                        <li class="nk-menu-item">
                                            <Link href="/dashboard/subscription/payments" class="nk-menu-link">
                                                <span class="nk-menu-icon"><em class="icon ni ni-report-profit"></em></span>
                                                <span class="nk-menu-text">Payment History</span>
                                            </Link>
                                        </li>
                                        <li class="nk-menu-item" v-if="user.is_subscribed">
                                            <a href="/dashboard/subscription/downloads" class="nk-menu-link">
                                                <span class="nk-menu-icon"><em class="icon ni ni-history"></em></span>
                                                <span class="nk-menu-text">Downloads History</span>
                                            </a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <Link href="/dashboard/address-lists" class="nk-menu-link">
                                                <span class="nk-menu-icon"><em class="icon ni ni-download-cloud"></em></span>
                                                <span class="nk-menu-text">Download Addresses</span>
                                            </Link>
                                        </li>
                                        <li class="nk-menu-item">
                                            <Link href="/dashboard/maps" class="nk-menu-link">
                                                <span class="nk-menu-icon"><em class="icon ni ni-globe"></em></span>
                                                <span class="nk-menu-text">Address Maps</span>
                                            </Link>
                                        </li>
                                        <!-- <li class="nk-menu-item">
                                        ...
                                        <li class="nk-menu-item">
                                            <a href="/" class="nk-menu-link">
                                                ...
                                                <span class="nk-menu-text">Main Website</span>
                                            </a>
                                        </li>
                                    </ul>
                                    <!-- Menu -->
